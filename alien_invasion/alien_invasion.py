...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Видалити усі кулі та прибульців, що зіткнулися
    ...
    def _update_screen(self):
        ...
        # Draw button "Play" if game not activate
    ...
    def _create_fleet(self):
        ...
        ship_height = self.ship.rect.height  # Виправлено
        ...
        for row_number in range(number_rows):
            for alien_number in range(number_aliens_x):
                self._create_alien(alien_number, row_number)  # Виправлено
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.y = alien.rect.height + 2 * alien.rect.height * row_number  # Додано ряд прибульців
    ...
    def _update_aliens(self):
        ...
        # Шукати зіткнення із прибульцями.
    ...
    def _ship_hit(self):
        """Реагування на зіткнення прибульця з кораблем"""
    ...
    def _check_play_button(self, mouse_pos):
        """Розпочати нову гру, коли користувач натисне кнопку Play"""
        button_clecked = self.play_button.rect.collidepoint(mouse_pos)
        if button_clecked and not self.stats.game_active:
